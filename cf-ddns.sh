...
auth_key="$CF_TOKEN"                                # Your API Token or Global API Key
zone_identifier="$CF_ZONE"                          # Can be found in the "Overview" tab of your domain
record_name="$TFL_HOST"                             # Which record you want to be synced
